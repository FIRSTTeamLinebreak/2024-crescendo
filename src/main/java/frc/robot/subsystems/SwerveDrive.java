...
public class SwerveDrive extends SubsystemBase {
    ...
    public SwerveDrive(Vision m_vision) {
        this.frontLeft = new SwerveModule(21, false,
                22, false, 23,
                SwerveConstants.Dimensions.magOffsetFL);
        this.frontRight = new SwerveModule(31, false,
                32, false, 33,
                SwerveConstants.Dimensions.magOffsetFR);
        this.backLeft = new SwerveModule(41, false,
                42, false, 43,
                SwerveConstants.Dimensions.magOffsetBL);
        this.backRight = new SwerveModule(51, false,
                52, false, 53,
    ...
    public void setDirection(
        ...
        if (fieldOriented) {
            setSpeed(ChassisSpeeds.fromFieldRelativeSpeeds(xSpeed, ySpeed,
                    turningSpeed, this.getRotation2d()));
        } else {
